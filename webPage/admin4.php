<!--Admin Page that shows checkings accounts-->
...
<body class="bg-dark">
    <header>
        <a href "#" class="logo">NOIR CAPITAL BANK (Admin 4)</a>
    ...
    <section class="bank">
        <div class="bank-text">
            ...
            <form style="margin-left: -200px; color:gray; margin-top: 50px;">
                ...
                <br>
                <br>
                <button type="button" onclick="openAllCheckings()" style="width: 200px;">User Details(Checkings)</button>
                <br>
                <br>
                    ...
                    <div class="col">
                        <div class="card-mt-5">
                            <div class="card-header">
                                <h2 class="display">Checking Accounts</h2>
                            </div>
                            <div class="card-body">
