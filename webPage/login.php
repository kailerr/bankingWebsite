...
<body>
    <header>
        <a href ="../webPage/homepage.html" class="logo">NOIR CAPITAL BANK</a>
    ...
    <section class="bank">
        ...
        <div class="bank-login">
            <form action="../webPage/login.php" method="post">
    ...
    <script>
        function openPopOutWindow() {
            var url = '../webPage/bankregistration.html'; // Replace with the actual URL
            var width = 550;
            var height = 550;
